<%-- 
    Document   : user
    Created on : Oct 20, 2015, 12:00:22 PM
    Author     : avlab6
--%>

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="nust.directory.model.Users" %>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="col-md-12">
                <div id="searchbox">
                    <form class="form-group">
                            <a href="usercreate.jsp" class="btn btn-info btn-lg1">
          ...
          <h2 class="sub-header">User Listings</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <c:forEach  var="user" items= '<%= request.getAttribute("listUsers") %>' >
                <tr> 
                    <td><c:out value="${user.name}" /></td>
                    <td><c:out value="${user.surname}" /></td>
                    <td><c:out value="${user.job_title}" /></td>
                    <td><c:out value="${user.user_id}" /></td
                    <td><c:out value="${user.password}" /></td
                </tr> 
                 <td><a href="${pageContext.request.contextPath}/EditUserController" class="btn btn-info btn-lg2"><span class="glyphicon glyphicon-edit">Edit</a></td>
                 <td><a class="btn btn-info btn-lg2" href="${pageContext.request.contextPath}/DeleteUserController?id=${user.user_id} ">Delete</a></td>
                 <td><a href="${pageContext.request.contextPath}/ViewUserController" class="btn btn-info btn-lg2"><span class="glyphicon glyphicon-info-sign">View</a></td>
                </c:forEach>
              </tbody>
            </table>
          </div>
