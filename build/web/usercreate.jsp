<%-- 
    Document   : usercreate
    Created on : Oct 20, 2015, 1:42:28 PM
    Author     : avlab6
--%>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="row">
            <div class="col-md-12">
                <div id="searchbox">
                    <form class="form-group1" action="${pageContext.request.contextPath}/AddUserController" method="post">
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="number_officesb" name="job_title"></td>
                                </tr>
                                <tr>
                                    <th>User ID</th>
                                    <th><label for="user_id"></label></th>
                                    <td><input type="text" class="form-control" id="number_floorsb" name="user_id"></td>
                                </tr>
                                <tr>
                                    <th>Password</th>
                                    <th><label for="password"></label></th>
                                    <td><input type="text" class="form-control" id="number_floorsb" name="password"></td>
                                </tr>
