<%-- 
    Document   : department
    Created on : Oct 20, 2015, 3:31:08 PM
    Author     : avlab6
--%>
...
<%@page import="nust.directory.model.Department"%>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="col-md-12">
                <div id="searchbox">
                    <form class="form-group">
                            <a href="departmentcreate.jsp" class="btn btn-info btn-lg1">
          ...
          <h2 class="sub-header">Department Listings</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                  <c:forEach  var="department" items= '<%= request.getAttribute("listDepartment") %>' >
                <tr>
                    <td><c:out value="${department.department_name}" /></td>
                    <td><c:out value="${department.department_id}" /></td>
                    <td><c:out value="${department.faculty_code}" /></td>
                    <td><c:out value="${department.building}" /></td>
                    <td><a href="${pageContext.request.contextPath}/EditDepartmentController" class="btn btn-info btn-lg2"><span class="glyphicon glyphicon-edit">Edit</a></td>
                    <td><a class="btn btn-info btn-lg2" href="${pageContext.request.contextPath}/DeleteDepartmentController?id=${department.department_id} "><span class="glyphicon glyphicon-erase">Delete</a></td>
                    <td><a href="${pageContext.request.contextPath}/ViewDepartmentController" class="btn btn-info btn-lg2"><span class="glyphicon glyphicon-info-sign">View</a></td>
                </tr>
