<%-- 
    ...
    Created on : Oct 20, 2015, 2:47:03 PM
    Author     : avlab6
--%>
                ...
                <div id="searchbox">
                    <form class="form-group1">
                        <table class="table table-striped">
                            ...
                            <th><a href="#" class="btn btn-info btn-lg1">
                                <span class="glyphicon glyphicon-add">Create
                                </a></th>
                            </tbody>
                        </table>
                    </form>    
