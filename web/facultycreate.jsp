<%-- 
    Document   : facultycreate
    Created on : Oct 20, 2015, 3:11:33 PM
    Author     : avlab6
--%>
                    ...
                    <form class="form-group1" action="${pageContext.request.contextPath}/AddFacultyController" method="post">
                        <table class="table table-striped">
                            <tbody>
                                <tr>   
                                    <th>Faculty Name</th>
                                    <th><label for="faculty_name"></label></th>
                                    <td><input type="text" class="form-control" id="nameb" name="faculty_name"></td>
                                </tr>
                                <tr>
                                    <th>Faculty Code</th>
                                    <th><label for="faculty_code"></label></th>
                                    <td><input type="text" class="form-control" id="building_Idb" name="faculty_code"></td>
                                </tr>
